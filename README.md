...
<h1>HTML Capabilities</h1>
  <ul>
  <li>Semantic Elements: HTML provides semantic elements like `<header></header>`, `<footer>`, `<nav>`, `<article>`, `<section>`, etc., which describe the purpose of the content, aiding accessibility and SEO.</li>
